    ...
    <body>
        ...
        <div id="principal">
            ...
            <form method="post" action="conclusion?op=update">
                <table>
                        <input type="hidden" name="id" value="${presidente.id}"/>
                        <tr>
                            <td>Presidente</td>
                            <td><input type="text" name="presidente" value="${presidente.nombrePresidente}"/></td>
                        </tr>
                        <tr>
                            <td>País</td>
                            <td><input type="text" name="pais" value="${presidente.pais.nombrePais}"/></td>
                        </tr>              
