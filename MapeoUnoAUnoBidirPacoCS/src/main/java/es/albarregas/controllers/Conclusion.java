...
public class Conclusion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (request.getParameter("op")) {
            case "update":
                presidente = (Presidente) gdao.getOne(presidente.getClass(), Integer.parseInt(request.getParameter("id")));
                pais = (Pais) gdao.getOne(pais.getClass(), Integer.parseInt(request.getParameter("id")));
